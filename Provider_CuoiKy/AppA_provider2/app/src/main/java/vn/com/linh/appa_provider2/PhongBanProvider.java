...
public class PhongBanProvider extends ContentProvider {
    ...
    public static String AUTHORITY="vn.com.linh.appa_provider2";
    public static String TABLE_PHONGBAN="PhongBans";//ten ban trong csdl
    public static String URL_PHONGBAN="content://"+AUTHORITY+"/"+TABLE_PHONGBAN;

    public static String TABLE_NHANVIEN="NhanViens";//ten ban trong csdl
